...
namespace ldso {
	...
	public:
		...
		shared_ptr<inertial::InertialCoarseTrackerHessian> inertialCoarseTrackerHessian = shared_ptr<inertial::InertialCoarseTrackerHessian>(new inertial::InertialCoarseTrackerHessian());

...
namespace ldso {
	namespace internal {
		...
		public:
			 ...
			 * @param HCalib
			 */
			void solveSystemF(int iteration, double lambda, shared_ptr<CalibHessian> HCalib, shared_ptr<inertial::InertialHessian> HInertial);
		...
		private:
			...
			MatXX H_I_sc = MatXX::Zero(CPARS, CPARS);

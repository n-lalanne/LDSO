...
namespace ldso {
	...
	void Frame::CreateFH(shared_ptr<Frame> frame, vector<ldso::inertial::ImuData> imuData) {
		frameHessian = shared_ptr<internal::FrameHessian>(new internal::FrameHessian(frame, imuData));
	}

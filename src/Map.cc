...
namespace ldso {
	...
	void Map::runPoseGraphOptimization() {
		...
		auto linearSolver = g2o::make_unique <g2o::LinearSolverEigen<BlockSolver<BlockSolverTraits<7, 3>>::PoseMatrixType>>();
		auto blockSolver = g2o::make_unique<BlockSolver<BlockSolverTraits<7, 3>>>(std::move(linearSolver));
		...
		// g2o::OptimizationAlgorithmDogleg *solver = new g2o::OptimizationAlgorithmDogleg(std::move(blockSolver));
